...
@section('content')
    ...
    <div class="mb-8">
        ...
        <h1 class="text-xl font-medium text-neutral-900 tracking-tight">Edit project</h1>
        <p class="text-sm text-neutral-400 mt-1">Update the details for <span class="text-neutral-600">{{ $project->title }}</span>.</p>
    </div>
    ...
    <div class="bg-white rounded border border-neutral-200 max-w-2xl mx-auto">
        ...
        <form action="{{ route('projects.update', $project) }}" method="POST" class="px-6 py-6 space-y-5">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <input
                    ...
                    class="w-full px-3 py-2 border rounded text-sm text-neutral-900 placeholder-neutral-300 focus:outline-none focus:ring-1 focus:ring-black focus:border-black transition
            ...
            <div>
                ...
                <textarea
                    ...
                    class="w-full px-3 py-2 border rounded text-sm text-neutral-900 placeholder-neutral-300 focus:outline-none focus:ring-1 focus:ring-black focus:border-black transition resize-none
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <select
                        id="status"
                        name="status"
                        class="w-full px-3 py-2 border rounded text-sm text-neutral-900 focus:outline-none focus:ring-1 focus:ring-black focus:border-black transition
